            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <div class="panel panel-default">
                        ...
                        <a href="/ratings" class="btn btn-primary">BACK</a>
                            ...
                            <div class="panel panel-default temp">
                                ...
                                <div class="panel-footer clearfix" style="background-color: #fff;">
                                    <a class="btn btn-success" href="/ratings/{{ $post->subject_id }}/edit">Calculate<span class="glyphicon glyphicon-pencil"></span></a>
